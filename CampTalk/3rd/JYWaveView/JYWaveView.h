...
@property (nonatomic, assign) CGFloat waveBottomCurrentHeight;
@property (nonatomic, assign) CGFloat waveBottomWillToHeight; // MAX To view.frame.height, default 0; Animated 0.1s
